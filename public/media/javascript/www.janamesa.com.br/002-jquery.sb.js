...
(function( $, window, undefined ) {
    ...
    var falseFunc = function() {
        ...
        closeSB = function( instantClose ) {
            if($sb.is(".open")) {
                ...
                if(instantClose === true) {
                  $dd.hide();
                  $sb.removeClass("open");
				  $sb.find('.display.select-sb').css('border-color', '#cfcfcf');
        ...
        openSB = function( instantOpen ) {
            ...
            blurAllButMe();
            $sb.addClass("open");
			$sb.find('.display.select-sb').css('border-color', '#818381');
            $ddCtx.append($dd);
            dir = positionSB();
        ...
        positionSB = function() {
            ...
            bottomSpace = $(window).scrollTop() + $(window).height() - $display.offset().top - $display.outerHeight() - 50;
            topSpace = $display.offset().top - $(window).scrollTop() - 50;
        ...
        this.init = function( opts ) {
            ...
            o = $.extend({
                ...
                arrowMarkup: "<div class='arrow_btn'><div></div></div>",
