...
/**
 * statistik of all premium restaurants in a city 
 * mail must be send on first day of every month to Oliver Dreber
 * @author alex
 * @since 24.02.2011
 */
clog('info', 'sending premium restaurants statistik to oliver dreber');
...
foreach ($cities as $city) {
    ...
    $email->setBodyText('Premium Dienstleister in ' . $city);
    $email->setSubject('Premium Dienstleister in ' . $city . ', Sheet 1');
