 ...
 * @author mlaug
 */
class Yourdelivery_Model_Order_Pdf_Private_Single_Fax extends Yourdelivery_Model_Order_Pdf_FaxAbstract{
    ...
    public function generatePdf(){
        ...
        $this->_latex->setTpl('order/private/single/bestellzettel');
