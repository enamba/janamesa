 ...
 * @author mlaug
 */
class Yourdelivery_Model_Order_Pdf_Company_Single_FaxCourier extends Yourdelivery_Model_Order_Pdf_FaxAbstract{
    ...
    public function generatePdf(){
        ...
        $this->_latex->setTpl('order/company/single/bestellzettel_courier');
