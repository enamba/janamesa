...
\begin{document}
	\vspace*{5mm}
		...
		\begin{longtable}{lp{15cm}}
            ...
            <<__('Firma:')|escape_latex>>                  & \textbf{<<$order->getLocation()->getCompany()|default:__("k.A.")|escape_latex>>}\\
    ...
    <</if>>
        ...
        \textbf{<<__('Bei Problemen oder Verzögerungen kontaktieren Sie bitte den Kunden direkt.')|escape_latex>>}
